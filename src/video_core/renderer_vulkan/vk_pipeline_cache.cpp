...
bool ShouldSkipShader(u64 shader_hash, const char* shader_type) {
    if (Config::getShaderSkipsEnabled()) {
        static std::vector<u64> skip_hashes = {0x4b0392bf,        0x9f37ecc3, 0x4a586e81,
            0x7ee03d3f,         0x1635154C,         0xf5874f2a8d7f2037, 0xf5874f2a65f418f9, 
            0x25593f798d7f2037,
            0x25593f7965f418f9, 0x2537adba98213a66, 0xfe36adba8c8b5626};
