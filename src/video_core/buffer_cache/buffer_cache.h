...
private:
    void ForEachBufferInRange(VAddr device_addr, u64 size, auto&& func) {
    ...
    void ForEachCachedPage(VAddr device_addr, u64 size, auto&& func) {
    ...
    Vulkan::Scheduler transfer_scheduler;
    ...
    SplitRangeMap<u64> gpu_modified_ranges;
