...
enum OrbisPadButtonDataOffset {
    ...
    LEFT_ANALOG_STICKUP = 2000001,
    LEFT_ANALOG_STICKDOWN = 2000002,
    LEFT_ANALOG_STICKLEFT = 2000003,
    LEFT_ANALOG_STICKRIGHT = 2000004,
    RIGHT_ANALOG_STICKUP = 2000005,
    RIGHT_ANALOG_STICKDOWN = 2000006,
    RIGHT_ANALOG_STICKLEFT = 2000007,
    RIGHT_ANALOG_STICKRIGHT = 2000008,
};
