...
// Device error codes
constexpr int ORBIS_DEVICE_ERROR = 0x80910001;
constexpr int ORBIS_DEVICE_SERVICE_ERROR_USER_NOT_LOGIN = 0x80910002;
constexpr int ORBIS_DEVICE_SERVICE_ERROR_INVALID_USER = 0x80910003;
